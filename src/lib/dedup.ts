...
// Re-post window: after this many hours the same deal can be posted again. Higher =
// less repetition (prioritizes NEW/distinct deals over re-showing the same ones).
// Default 24h (at most ~1x/day per deal). Configurable via DEDUP_TTL_HOURS.
